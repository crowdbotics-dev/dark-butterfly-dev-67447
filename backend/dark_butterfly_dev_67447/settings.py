"""
Django settings for dark_butterfly_dev_67447 project.
...
ROOT_URLCONF = 'dark_butterfly_dev_67447.urls'
...
WSGI_APPLICATION = 'dark_butterfly_dev_67447.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "dark_butterfly_dev_67447 API",
    "DESCRIPTION": "API documentation for dark_butterfly_dev_67447 App",
    "VERSION": "v1",
}
